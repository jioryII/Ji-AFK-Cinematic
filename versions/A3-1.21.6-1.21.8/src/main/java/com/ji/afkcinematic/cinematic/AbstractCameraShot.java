...
public abstract class AbstractCameraShot implements CameraShot {
    ...
    protected Vec3d getCircularOffset(float angleDegrees, float distance) {
        ...
        // Minecraft changed the sin/cos parameter descriptor inside 1.21.x.
        // JDK trig keeps this grouped artifact binary-compatible across patches.
        return new Vec3d(Math.cos(rads) * distance, 0, Math.sin(rads) * distance);
    }
