...
public class JiAFKCinematic implements ClientModInitializer {
    ...
    private static final java.util.Set<String> CRITICAL_MIXINS = java.util.Set.of(
            ...
            "ClientWorldFishingParticleMixin");
    ...
    private static void reportMissingCriticalMixins() {
        ...
        if (!com.ji.afkcinematic.diagnostic.MixinState.didApply(cameraMixin)) {
            LOGGER.warn("Critical mixin '{}' did not apply — the camera feature will be broken. " +
                    "This usually means a Minecraft API change; please report this version combination.", cameraMixin);
        }
    }
