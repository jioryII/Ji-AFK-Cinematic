...
class CinematicInputPolicyTest {
    ...
    @Test
    void fishingCinematicIgnoresMouseAndGameplayActionsButKeepsExplicitExits() {
        for (CinematicInputPolicy.Event event : new CinematicInputPolicy.Event[]{
                LOOK, GAMEPLAY_ACTION, CHAT_OPEN, CHAT_INPUT, JUMP_SNEAK}) {
            assertFalse(CinematicInputPolicy.shouldRegisterActivity(
                    true, true, PersistentCinematicMode.NORMAL, false, event));
        }
        assertTrue(CinematicInputPolicy.shouldRegisterActivity(
                true, true, PersistentCinematicMode.NORMAL, false, MOVE));
        assertTrue(CinematicInputPolicy.shouldRegisterActivity(
                true, true, PersistentCinematicMode.NORMAL, false, ESCAPE));
    }
