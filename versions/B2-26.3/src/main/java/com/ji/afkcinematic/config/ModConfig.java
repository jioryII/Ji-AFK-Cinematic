...
public class ModConfig {
    ...
    // Native codes drive the current session; stable vanilla names preserve them across backends.
    public int menuKey1 = InputConstants.KEY_F7;
    public int menuKey2 = InputConstants.KEY_H;
    public int toggleKey1 = InputConstants.KEY_LCONTROL;
    public int toggleKey2 = InputConstants.KEY_H;
    public int immediateKey1 = InputConstants.KEY_F7;
    public int immediateKey2 = InputConstants.KEY_I;
    ...
    public void recalculate() {
        ...
        // -1 disables a binding. Keep native key codes within a serializable range.
        ...
        if (menuKey1 == toggleKey1 && menuKey2 == toggleKey2
            ...
            com.ji.afkcinematic.JiAFKCinematic.LOGGER.warn(
                ...
                menuKey1, menuKey2);
            menuKey1 = InputConstants.KEY_F7; menuKey2 = InputConstants.KEY_H;
            toggleKey1 = InputConstants.KEY_LCONTROL; toggleKey2 = InputConstants.KEY_H;
        }
        ...
        // Every enabled pair must contain two representable key codes.
        if (!isDisabledShortcut(menuKey1, menuKey2)
            ...
            menuKey1 = InputConstants.KEY_F7;
            menuKey2 = InputConstants.KEY_H;
        }
        if (!isDisabledShortcut(toggleKey1, toggleKey2)
            ...
            toggleKey1 = InputConstants.KEY_LCONTROL;
            toggleKey2 = InputConstants.KEY_H;
        }
        if (!isDisabledShortcut(immediateKey1, immediateKey2)
            ...
            immediateKey1 = InputConstants.KEY_F7;
            immediateKey2 = InputConstants.KEY_I;
        }
    }
