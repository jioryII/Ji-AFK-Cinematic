...
public class JiAFKCinematicMixinPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        String version = net.fabricmc.loader.api.FabricLoader.getInstance()
                ...
                .orElse("");
        boolean usesDedicatedHud = version.startsWith("26.2") || version.startsWith("26.3");
        if (mixinClassName.endsWith("Hud262Mixin")) return usesDedicatedHud;
        if (mixinClassName.endsWith("InGameHudMixin")) return !usesDedicatedHud;
        return true;
    }
